...
const InputBox = ({ onSendMessage, isDisabled }) => {
    ...
    return (
        <div className="flex flex-col w-full">
            <form
                onSubmit={handleSend}
                className="flex items-center gap-3 px-4 py-3 rounded-tl-xl rounded-tr-xl bg-[#AF1614]"
            >
                <div className="flex-grow relative">
                    <input
                        type="text"
                        className="w-full bg-[#AF1614] px-4 pr-16 py-2 text-sm text-[#f9eded] focus:outline-none focus:ring-1 focus:ring-[#ab252c] placeholder-white"
                        value={input}
